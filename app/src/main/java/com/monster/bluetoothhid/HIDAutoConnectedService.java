...
public class HIDAutoConnectedService extends Service implements AutoConnectListener{
    ...
    private static String HID_NAME = "MONSTER"; // 连接的蓝牙设备名
    private static String HID_ADDR = "34:03:DE:4D:27:C1"; // 连接的蓝牙设备地址
...
//					stopSelf();
                    ...
                    if(!mReconneted && fixBugForTwiceConnected){
                        ...
                        //두 번째 연결은 일반적으로 성공할 수 있으며, 이때 저장
...
//스캔을 시작한 후 5분 이내에 스캔하지 않으면 다시 스캔하지 않음
